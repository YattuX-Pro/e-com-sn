...
{
    /// <inheritdoc />
    public partial class AddTricycleProperties : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Freinage = table.Column<string>(type: "text", nullable: false),
                    SystemeD = table.Column<string>(type: "text", nullable: false),
                    DimensionCaisseChargement = table.Column<string>(type: "text", nullable: false),
                    BoiteVitesse = table.Column<string>(type: "text", nullable: false),
                    SpecificationTechnique = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
